...
if ($_SESSION['id']) {
  ...
  $userStmtsNav = $pdo->prepare('SELECT * FROM utilisateur WHERE id = :id');
  $userStmtsNav->bindValue(':id', $_SESSION['id']);
  $userStmtsNav->execute();
  $userNav = $userStmtsNav->fetch();
}
?>
